...
\name{Tony}{Mogoa Ombaso}
% \position{Software Architect{\enskip\cdotp\enskip}Security Expert}
\address{Respublica, Prospect Street, Pretoria, South Africa}

\mobile{+27 79 101 5649}
\email{mogoa.tonny@gmail.com}
\dateofbirth{Feb 12th, 2001}
\github{tmogoa}
\linkedin{tony-mogoa-88b39b17a}
\medium{tony-mogoa}
% \gitlab{gitlab-id}
